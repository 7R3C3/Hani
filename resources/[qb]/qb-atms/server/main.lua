        ...
        if dailyWith < Config.DailyLimit then
            ...
            if xCH ~= nil then
                ...
                if bankCount > 0 then
                    ...
                    TriggerClientEvent('QBCore:Notify', src, "Hævet DKK" .. data.amount .. ' fra kreditkort. Daglig tilbagetrækning: ' .. dailyWithdraws[cardHolder], "success")
                else
                ...
                if bankCount > 0  then
                    ...
                    TriggerClientEvent('QBCore:Notify', src, "Ikke nok pengey", "error")
                end
